...
namespace OpenNos.World
{
    public static class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.Title = $"World Server{(_isDebug ? " TestServer Environment" : "")}";
            ...
            if (!ignoreStartupMessages)
            {
                ...
                string text = $"TEST WORLD SERVER v{fileVersionInfo.ProductVersion}dev - PORT : {_port} by OpenNos Team ";
