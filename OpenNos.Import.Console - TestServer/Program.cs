...
namespace OpenNos.Import.Console
{
    public static class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            System.Console.Title = $"OpenNos Parser{(isDebug ? " TestServer Environment" : "")}";
            ...
            if (!ignoreStartupMessages)
            {
                ...
                string text = $"OpenNos TestServer Parser VERSION {fileVersionInfo.ProductVersion} by OpenNos Team";
