...
namespace OpenNos.GameObject.Event
{
    public static class ACT4SHIP
    {
        ...
        {
            EventHelper.Instance.RunEvent(new EventContainer(ServerManager.GetMapInstance(ServerManager.GetBaseMapInstanceIdByMapId(2628)), EventActionType.NPCSEFFECTCHANGESTATE, true));
    ...
    public static class Act4ShipThread
    {
        ...
        public static void Run(byte faction)
        {
            ...
            while (true)
            {
                ...
                map.Broadcast(UserInterfaceHelper.GenerateMsg(Language.Instance.GetMessageFromKey("SHIP_MINUTE"), 1));             
                ...
                map.Broadcast(UserInterfaceHelper.GenerateMsg(string.Format(Language.Instance.GetMessageFromKey("SHIP_SECONDS"), 5), 0));
                Thread.Sleep(5 * 1000);
                lockShip();
                 map.Broadcast(UserInterfaceHelper.GenerateMsg(string.Format(Language.Instance.GetMessageFromKey("SHIP_SECONDS"), 10), 0));
                Thread.Sleep(10 * 1000); 
        ...
        private static void lockShip() => EventHelper.Instance.RunEvent(new EventContainer(ServerManager.GetMapInstance(ServerManager.GetBaseMapInstanceIdByMapId(2628)), EventActionType.NPCSEFFECTCHANGESTATE, true));

        private static void openShip() => EventHelper.Instance.RunEvent(new EventContainer(ServerManager.GetMapInstance(ServerManager.GetBaseMapInstanceIdByMapId(2628)), EventActionType.NPCSEFFECTCHANGESTATE, false));
