...
namespace OpenNos.GameObject.Event
{
    public static class InstantBattle
    {
        ...
        public static void GenerateInstantBattle()
        {
            ...
            {
                i++;
                if (s.Character.Level > 99 && level <= 99)
                {
                    i = 0;
                    instancelevel = 90;
                }
        ...
        public class InstantBattleTask
        {
            ...
            public static void Run(Tuple<MapInstance, byte> mapinstance)
            {
                ...
                Thread.Sleep(10 * 1000);
                if (!mapinstance.Item1.Sessions.Skip(0).Any())
                {
                ...
                Observable.Timer(TimeSpan.FromMinutes(12)).Subscribe(X =>
                {
                    for (int d = 0; d < 180; d++)
                    {
                        if (!mapinstance.Item1.Monsters.Any(s => s.CurrentHp > 0))
                        {
                            ...
                            {
                                cli.Character.GenerateFamilyXp(cli.Character.Level * 5);
                                cli.Character.GetReputation(cli.Character.Level * 50);
                                cli.Character.Gold += cli.Character.Level * 11000;
                                cli.Character.Gold = cli.Character.Gold > maxGold ? maxGold : cli.Character.Gold;
                                cli.Character.SpAdditionPoint += cli.Character.Level * 200;
                                ...
                                cli.SendPacket(cli.Character.GenerateSay(string.Format(Language.Instance.GetMessageFromKey("WIN_MONEY"), cli.Character.Level * 11000), 10));
                                cli.SendPacket(cli.Character.GenerateSay(string.Format(Language.Instance.GetMessageFromKey("WIN_REPUT"), cli.Character.Level * 200), 10));
                                if (cli.Character.Family != null)
                                {
                                    cli.SendPacket(cli.Character.GenerateSay(string.Format(Language.Instance.GetMessageFromKey("WIN_FXP"), cli.Character.Level * 5), 10));
                                }
                                cli.SendPacket(cli.Character.GenerateSay(string.Format(Language.Instance.GetMessageFromKey("WIN_SP_POINT"), cli.Character.Level * 200), 10));
                            }
                            break;
                        }
                        Thread.Sleep(1000);
            ...
            private static List<Tuple<short, int, short, short>> getInstantBattleDrop(Map map, short instantbattletype, int wave)
            {
                ...
                switch (instantbattletype)
                {
                    case 1:
                        switch (wave)
                        {
                            case 0:
                                ...
                                dropParameters.AddRange(generateDrop(map, 2027, 8, 20));
                                dropParameters.AddRange(generateDrop(map, 2018, 5, 10));
                                dropParameters.AddRange(generateDrop(map, 180, 5, 1));
                                break;

                            case 1:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 3500));
                                dropParameters.AddRange(generateDrop(map, 1002, 8, 6));
                                dropParameters.AddRange(generateDrop(map, 1005, 16, 6));
                                dropParameters.AddRange(generateDrop(map, 181, 5, 1));
                                break;

                            case 2:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 4000));
                                dropParameters.AddRange(generateDrop(map, 1002, 10, 10));
                                dropParameters.AddRange(generateDrop(map, 1005, 10, 10));
                                break;

                            case 3:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 5000));
                                dropParameters.AddRange(generateDrop(map, 1003, 10, 15));
                                dropParameters.AddRange(generateDrop(map, 1006, 10, 15));
                                break;
                        }
                        break;
                    ...
                    case 40:
                        ...
                        {
                            case 0:
                                dropParameters.AddRange(generateDrop(map, 1046, 15,6000));
                                dropParameters.AddRange(generateDrop(map, 1008, 5, 3));
                                dropParameters.AddRange(generateDrop(map, 180, 5, 1));
                                break;

                            case 1:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 6500));
                            ...
                            case 3:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 8000));
                                dropParameters.AddRange(generateDrop(map, 1009, 10, 3));
                                dropParameters.AddRange(generateDrop(map, 1248, 5, 1));
                                dropParameters.AddRange(generateDrop(map, 1030, 15, 1));
                                dropParameters.AddRange(generateDrop(map, 5422, 3, 1));
                                break;
                        }
                    ...
                    case 50:
                        ...
                        {
                            case 0:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 9000));
                                dropParameters.AddRange(generateDrop(map, 1008, 5, 3));
                                dropParameters.AddRange(generateDrop(map, 180, 5, 1));
                                break;

                            case 1:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 9500));
                                dropParameters.AddRange(generateDrop(map, 1008, 8, 3));
                                dropParameters.AddRange(generateDrop(map, 181, 5, 1));
                                break;
                            ...
                            case 3:
                                ...
                                dropParameters.AddRange(generateDrop(map, 2282, 15, 1));
                                dropParameters.AddRange(generateDrop(map, 5422, 3, 1));
                                break;
                        }
                        break;
                    ...
                    case 60:
                        ...
                        {
                            case 0:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 13000));
                                dropParameters.AddRange(generateDrop(map, 1010, 8, 4));
                                dropParameters.AddRange(generateDrop(map, 1246, 5, 1));
                                break;

                            case 1:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 13500));
                                dropParameters.AddRange(generateDrop(map, 1010, 10, 3));
                                dropParameters.AddRange(generateDrop(map, 1247, 5, 1));
                                break;

                            case 2:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 14000));
                            ...
                            case 3:
                                ...
                                dropParameters.AddRange(generateDrop(map, 1030, 30, 3));
                    ...
                    case 70:
                        ...
                        {
                            case 0:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 16000));
                                dropParameters.AddRange(generateDrop(map, 1010, 8, 3));
                                dropParameters.AddRange(generateDrop(map, 1246, 5, 1));
                                break;

                            case 1:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 16500));
                                dropParameters.AddRange(generateDrop(map, 1010, 15, 4));
                                dropParameters.AddRange(generateDrop(map, 1247, 10, 1));
                                break;

                            case 2:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 17000));
                            ...
                            case 3:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 18000));
                                dropParameters.AddRange(generateDrop(map, 1011, 13, 5));
                                dropParameters.AddRange(generateDrop(map, 1248, 13, 1));
                                dropParameters.AddRange(generateDrop(map, 1029, 5, 1));
                    ...
                    case 80:
                        ...
                        {
                            case 0:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 19000));
                                dropParameters.AddRange(generateDrop(map, 1011, 15, 5));
                                dropParameters.AddRange(generateDrop(map, 1246, 15, 1));
                                break;

                            case 1:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 19500));
                                dropParameters.AddRange(generateDrop(map, 1011, 15, 5));
                            ...
                            case 3:
                                dropParameters.AddRange(generateDrop(map, 1046, 30, 25000));
                    ...
                    case 90:
                        switch (wave)
                        {
                            case 0:
                                ...
                                dropParameters.AddRange(generateDrop(map, 1011, 15, 10));
                                dropParameters.AddRange(generateDrop(map, 1246, 15, 2));
                                break;

                            case 1:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 40000));
                                dropParameters.AddRange(generateDrop(map, 1011, 15, 10));
                                dropParameters.AddRange(generateDrop(map, 1247, 15, 2));
                                break;
                            ...
                            case 3:
                                dropParameters.AddRange(generateDrop(map, 1046, 30, 80000));
                                dropParameters.AddRange(generateDrop(map, 1011, 30, 10));
                                dropParameters.AddRange(generateDrop(map, 1030, 30, 15));
                                dropParameters.AddRange(generateDrop(map, 2282, 12, 15));
                                dropParameters.AddRange(generateDrop(map, 5422, 6, 1));
                                break;
                        }
                        break;
                }
                ...
                switch (instantbattletype)
                {
                    ...
                    case 90:
                        switch (wave)
                        {
                            ...
                            case 1:
                                SummonParameters.AddRange(map.GenerateMonsters(2300, 15, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(2301, 15, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(2303, 15, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(1055, 15, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(1924, 16, true, new List<EventContainer>()));
                                break;

                            case 2:
                                SummonParameters.AddRange(map.GenerateMonsters(2006, 15, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(2523, 15, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(2525, 15, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(1047, 15, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(1903, 16, true, new List<EventContainer>()));
                                break;

                            case 3:
                                SummonParameters.AddRange(map.GenerateMonsters(2567, 15, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(2517, 15, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(2516, 15, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(2508, 15, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(2509, 15, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(2300, 16, true, new List<EventContainer>()));
                                break;

                            case 4:
                                SummonParameters.AddRange(map.GenerateMonsters(2559, 13, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(2560, 13, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(2561, 13, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(2503, 13, true, new List<EventContainer>()));
                                SummonParameters.AddRange(map.GenerateMonsters(2566, 13, true, new List<EventContainer>()));
