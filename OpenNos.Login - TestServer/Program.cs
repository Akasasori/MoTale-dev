        ...
        public static void Main(string[] args)
        {
            checked
            {
                try
                {
                    ...
                    Console.Title = $"Login Server{(_isDebug ? " TestServer Environment" : "")}";
                    ...
                    if (!ignoreStartupMessages)
                    {
                        ...
                        string text = $"TEST LOGIN SERVER v{fileVersionInfo.ProductVersion}dev - PORT : {port} by OpenNos Team";
