...
namespace OpenNos.Import.Console
{
    public class ImportFactory
    {
        ...
        public void ImportMaps()
        {
            ...
            ThreadSafeSortedList<short, short> dictionarySecondMapId = new ThreadSafeSortedList<short, short>();
            ...
            Parallel.ForEach(_packetList.Where(o => o[0].Equals("at")), linesave =>
            {
                ...
                {
                    dictionarySecondMapId[short.Parse(linesave[2])] = short.Parse(cmap[2]);
                }
            });
            ...
            Parallel.ForEach(mapPartitioner, new ParallelOptions { MaxDegreeOfParallelism = 8 }, file =>
            {
                ...
                int music = 0;
                short mapId = short.Parse(file.Name);
                short secondMapId = short.Parse(file.Name);

                if (dictionarySecondMapId.ContainsKey(mapId))
                {
                    secondMapId = dictionarySecondMapId[mapId];
                }

                if (dictionaryId.ContainsKey(secondMapId) && dictionaryIdLang.ContainsKey(dictionaryId[secondMapId]))
                {
                    name = dictionaryIdLang[dictionaryId[secondMapId]];
                }
        ...
        public void ImportTeleporters()
        {
            ...
            TeleporterDTO teleporter = null;
            foreach (string[] currentPacket in _packetList.Where(o => o[0].Equals("at") || (o[0].Equals("n_run") && (o[1].Equals("335") || o[1].Equals("336") || o[1].Equals("16") || o[1].Equals("26") || o[1].Equals("45") || o[1].Equals("301") || o[1].Equals("132") || o[1].Equals("5002") || o[1].Equals("5012")))))
            {
                if (currentPacket.Length > 4 && currentPacket[0] == "n_run")
                {
