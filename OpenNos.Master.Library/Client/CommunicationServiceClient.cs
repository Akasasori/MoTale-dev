...
namespace OpenNos.Master.Library.Client
{
    public class CommunicationServiceClient : ICommunicationService
    {
        ...
        public string RetrieveRegisteredWorldServers(string username, int sessionId, bool ignoreUserName, string regionCode) => _client.ServiceProxy.RetrieveRegisteredWorldServers(username, sessionId, ignoreUserName, regionCode);
